    ...
    {   
        $categoryResult = [
            "F" => [
                ...
                "<option value='110'>Juvenil(14-17 años)</option>",
                "<option value='111'>Libre (18-39 años)</option>",
                "<option value='112'>Master (40-49 años)</option>",
                "<option value='113'>Veteranos (50+)</option>",
                "<option value='114'>Caminata (libre)</option>",
                "<option value='115'>Infantil 4-5 años</option>",
                "<option value='116'>Infantil 6-7 años</option>",
                "<option value='117'>Infantil 8-9 años</option>",
                "<option value='118'>Infantil 10-13 años</option>",                
            ],
            "M" => [
                "<option value='0'>NO TIENE CATEGORÍA</option>",
                "<option value='110'>Juvenil(14-17 años)</option>",
