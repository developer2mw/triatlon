                    ...
                    <div class="block-content">
                            ...
                            <div class="col-sm-12">                                                                
                                <div class="col-xs-12 col-sm-4">
                                    <div class="font-w700 text-gray-darker animated fadeIn">
                                        <small>JUVENIL FEMENIL / VARONIL</small>
                                    </div>
                        ...
                        <div class="row items-push text-uppercase" style="text-align: center;">                                                  
                            <div class="col-sm-12">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="font-w700 text-gray-darker animated fadeIn">
                                        <small>VETERANOS FEMENIL / VARONIL</small>
                                    </div>
                                    <label class="h2 font-w300 text-primary animated flipInX" style="font-size: 16px;">
                                        <span class="14C01M">{{$categorias['veteranos_femenil']}}</span> <small>Mujeres</small> / <span class="14C01F">{{$categorias['veteranos_varonil']}}</span> <small>Hombres</small>
                                    </label>
                                </div>                                
                                <div class="col-xs-12 col-sm-6">
                                    <div class="font-w700 text-gray-darker animated fadeIn">
                                        <small>CAMINATA FEMENIL / VARONIL</small>
                                    </div>
                                    <label class="h2 font-w300 text-primary animated flipInX" style="font-size: 16px;">
                                        <span class="14C01M">{{$categorias['caminata_femenil']}}</span> <small>Mujeres</small> / <span class="14C01F">{{$categorias['caminata_varonil']}}</span> <small>Hombres</small>
                                    </label>
                                </div>                         
                            </div>
                        </div>
                        <div class="row items-push text-uppercase" style="text-align: center;">                                                  
                            <div class="col-sm-12">
                                <div class="col-xs-12 col-sm-4">
                                    <div class="font-w700 text-gray-darker animated fadeIn">
                                        <small>INFANTIL 4-5 AÑOS FEMENIL / VARONIL</small>
                                    </div>
                                    <label class="h2 font-w300 text-primary animated flipInX" style="font-size: 16px;">
                                        <span class="14C01M">{{$categorias['infantil_4_5_femenil']}}</span> <small>Mujeres</small> / <span class="14C01F">{{$categorias['infantil_4_5_varonil']}}</span> <small>Hombres</small>
                                    </label>
                                </div>                                
                                <div class="col-xs-12 col-sm-4">
                                    <div class="font-w700 text-gray-darker animated fadeIn">
                                        <small>INFANTIL 6-7 AÑOS FEMENIL / VARONIL</small>
                                    </div>
                                    <label class="h2 font-w300 text-primary animated flipInX" style="font-size: 16px;">
                                        <span class="14C01M">{{$categorias['infantil_6_7_femenil']}}</span> <small>Mujeres</small> / <span class="14C01F">{{$categorias['infantil_6_7_varonil']}}</span> <small>Hombres</small>
                                    </label>
                                </div>
                                <div class="col-xs-12 col-sm-4">
                                    <div class="font-w700 text-gray-darker animated fadeIn">
                                        <small>INFANTIL 8-9 AÑOS FEMENIL / VARONIL</small>
                                    </div>
                                    <label class="h2 font-w300 text-primary animated flipInX" style="font-size: 16px;">
                                        <span class="14C01M">{{$categorias['infantil_8_9_femenil']}}</span> <small>Mujeres</small> / <span class="14C01F">{{$categorias['infantil_8_9_varonil']}}</span> <small>Hombres</small>
                                    </label>
                                </div>                         
                            </div>
                        </div>
                        <div class="row items-push text-uppercase" style="text-align: center;">                                                  
                            <div class="col-sm-12">
                                <div class="col-xs-12 col-sm-12">
                                    <div class="font-w700 text-gray-darker animated fadeIn">
                                        <small>INFANTIL 10-13 AÑOS FEMENIL / VARONIL</small>
                                    </div>
                                    <label class="h2 font-w300 text-primary animated flipInX" style="font-size: 16px;">
                                        <span class="14C01M">{{$categorias['infantil_10_13_femenil']}}</span> <small>Mujeres</small> / <span class="14C01F">{{$categorias['infantil_10_13_varonil']}}</span> <small>Hombres</small>
                                    </label>
                                </div>                         
                            </div>
                        </div>                                             
                            ...
                            <div class="col-sm-12 col-md-8 col-md-offset-2">
                                ...
                                <div class="row">
                                    <div class="col-sm-12" style="margin-top: 30px;">
                                        ...
                                        <div class="col-xs-12 col-sm-4">
                                            <div class=" text-gray-darker animated fadeIn">
                                                Extra Extra Grande (XXL)<br>
                                                <label class="h2 font-w300 text-primary animated flipInX">
                                                    <span class="14XBMP">{{$tallas['talla_xxl_h']}}</span>
                                                    {{-- /<span class="14XBMT">{{$tallasM['XXL']}}</span> --}}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12" style="margin-top: 30px;">
                                        ...
                                        <div class="col-xs-6 col-sm-4">
                                            <div class=" text-gray-darker animated fadeIn">
                                                Extra Chica (XS)<br>
                                                <label class="h2 font-w300 text-primary animated flipInX">
                                                    <span class="14SBFP">{{$tallas['talla_xs_m']}}</span>
                                                    {{-- /<span class="14SBFT">{{$tallasF['XS']}}</span> --}}
                                                </label>
                                            </div>
                                        </div>                                   
                                        <div class="col-xs-6 col-sm-4">
                                        ...
                                        <div class="col-xs-12 col-sm-4">
                                            <div class=" text-gray-darker animated fadeIn">
                                                Grande (L)<br>
                                                <label class="h2 font-w300 text-primary animated flipInX">
                                                    <span class="14LBFP">{{$tallas['talla_xl_m']}}</span>
                                                    {{-- /<span class="14LBFT">{{$tallasF['XL']}}</span> --}}
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-4">
                                            <div class=" text-gray-darker animated fadeIn">
                                                Extra Extra Grande (XXL)<br>
                                                <label class="h2 font-w300 text-primary animated flipInX">
                                                    <span class="14LBFP">{{$tallas['talla_xxl_m']}}</span>
                                                    {{-- /<span class="14LBFT">{{$tallasF['XXL']}}</span> --}}
                                                </label>
                                            </div>
                                        </div>
                                    </div>                                    
                                    ...
                                    <div class="col-sm-12" style="margin-top: 30px;">
                                        ...
                                        <div class="col-xs-12 col-sm-4">
                                            <div class=" text-gray-darker animated fadeIn">
                                                Infantil (4)<br>
                                                <label class="h2 font-w300 text-primary animated flipInX">
                                                    <span class="14LBFP">{{$tallas['talla_4']}}</span>                                                    
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-4">
