...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
 <head>
  ...
  <title>{{$content['titulo'] ." ". $content['subtitulo']}}</title><!--[if (mso 16)]>
    <style type="text/css">
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:558px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">                    
                     <tr>
                      <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-top:30px;padding-bottom:20px"><h1 style="Margin:0;font-family:georgia, times, 'times new roman', serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:30px;font-style:normal;font-weight:normal;line-height:36px;color:#023047"><strong>¡Estas a un paso de terminar<br> el proceso de inscripción!</strong><br></h1><br><br><span style="font-size:18px;">Para obtener tu espacio en el evento realiza tu pago, <br> aquí te compartimos los métodos de pago disponibles</span><br><br><br><h2 style="Margin:0;font-family:georgia, times, 'times new roman', serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:24px;font-style:normal;font-weight:normal;line-height:29px;color:#023047">{{$content['titulo']}} <br><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:40px;letter-spacing:0;color:#666666;font-size:20px">Formas de pago en línea: <strong><a style="text-decoration:none;color:#999999;" href="{{$content['link']}}">{{$content['link']}}</a></p><br> {{$content['subtitulo']}}</h2></td>
                     </tr> 
                     <tr>
                      <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:5px;padding-top:5px"></td>
                     </tr>                    
                     <tr>
                 ...
                 <tr>
                  <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:558px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                      <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:5px;padding-top:5px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:40px;letter-spacing:0;color:#666666;font-size:20px">Categoría : <strong>{{$content['categoria']}}</strong></p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
